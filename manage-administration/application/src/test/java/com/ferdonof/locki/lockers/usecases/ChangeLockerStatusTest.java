...
@ExtendWith(MockitoExtension.class) class ChangeLockerStatusTest {
  @Mock private TransactionTemplate txTemplate;

  @Mock private LockerRepositoryPort lockerRepository;

  @InjectMocks private ChangeLockerStatusImpl changeLockerStatusImpl;
  ...
  @Test void execute_whenLockerExists_shouldChangeStatus() {
  ...
  @Test void execute_whenLockerNotFound_shouldThrowLockerNotFoundException() {
    final var lockerId = UUID.randomUUID();
  ...
  @Test void execute_withDifferentStatuses_shouldChangeToEachStatus() {
    final var lockerId = UUID.randomUUID();
