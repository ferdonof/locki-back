...
class LocationMapperTest {
  ...
  void toDomain_whenValidEntity_shouldMapAllFields() {
    ...
    assertThat(result.lat()).isEqualByComparingTo(new BigDecimal("40.416775"));
    assertThat(result.lon()).isEqualByComparingTo(new BigDecimal("-3.703790"));
  ...
  void toEntity_whenValidDomain_shouldMapAllFields() {
    ...
    final Location location = Location
        ...
        .city("Barcelona")
        .country("Spain")
        .lat(new BigDecimal("41.385064"))
        .lon(new BigDecimal("2.173404"))
        .version(0L)
        .createdAt(now)
        .updatedAt(now)
        .build();
    ...
    assertThat(result.getLat()).isEqualByComparingTo(new BigDecimal("41.385064"));
    assertThat(result.getLon()).isEqualByComparingTo(new BigDecimal("2.173404"));
